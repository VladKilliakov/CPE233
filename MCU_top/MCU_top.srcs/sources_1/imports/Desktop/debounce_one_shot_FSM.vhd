...
architecture Behavioral of db_1shot_FSM is
   ...
   constant c_LOW_GOING_HIGH_CLOCKS : std_logic_vector := x"33"; -- 25 clks
   constant c_HIGH_GOING_LOW_CLOCKS : std_logic_vector := x"66"; -- 50 clks
   constant c_ONE_SHOT_CLOCKS       : std_logic_vector := x"04"; -- 3 clks
