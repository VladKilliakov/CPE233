...
init:     MOV r0, 0xF6
          ...
          MOV r1, 0x00
          MOV r2, 0x00
          MOV r15, 0x03 ; intialize the orgin of the first col
          MOV r16, 0x03 ; intialize the orgin of the first row
		  MOV r5,0x00
...
get_cramer_matrix: MOV r10, 0x00
                   MOV r11, 0x00
                   MOV r14, 0x03
                   OUT r10, row
		           OUT r11, col
                   OUT r14, color
                   MOV r30, 0x03
set_delay:         MOV r31, 0xFF
dec_delay:         SUB r31, 0x01
                   OUT r10, row
		           OUT r11, col
                   OUT r14, color
                   BRCS dec_loop
                   BRCC dec_delay
dec_loop:          SUB r30, 0x01
                   BRCS init
                   BRCC set_delay
